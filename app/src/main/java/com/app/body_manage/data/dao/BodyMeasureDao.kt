...
interface BodyMeasureDao {
    ...
    @Query("SELECT ui, calendar_date, capture_date, capture_time, AVG(weight) as weight, AVG(fat) as fat, photo_uri, tall, memo FROM bodyMeasures GROUP BY bodyMeasures.calendar_date")
